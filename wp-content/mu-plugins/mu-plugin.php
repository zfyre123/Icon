...
require_once __DIR__ . '/wpengine-common/class-wp-engine-abstraction.php';
...
$wpe_wp_engine_abstraction = new \wpe\plugin\Wp_Engine_Abstraction();
 ...
 */
\wpe\plugin\Wpe_Cache_Manager::add_action( $wpe_wp_abstraction, $wpe_wp_engine_abstraction, $wpe_wp_cli_abstraction );
