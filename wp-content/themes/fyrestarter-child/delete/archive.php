          ...
          ?>
            ...
            <?php if ($counter % 2 != 0) { ?>
              <div class="row blog-row row-eq-height">
                ...
                <div class="col-lg-6 cover-bg blog-main-img" style="background-image:url('<?php echo $image; ?>');">
                </div>
              </div>
            <?php } else { ?>
              <div class="row blog-row row-eq-height">
                ...
                <div class="col-lg-6 pull-lg-6 cover-bg blog-main-img" style="background-image:url('<?php echo $image; ?>');">
                </div>
              </div>
            <?php } ?>
          <?php endwhile; ?>
...
<script>
   ...
   var Page = 1;
   var counter = 0;
   var Taxonomy = "<?php echo get_queried_object()->taxonomy; ?>";
   var Slug = "<?php echo get_queried_object()->slug; ?>";

   function load_more_categorized_stories() {
    jQuery.getJSON( "https://"+window.location.hostname+"/wp-json/custom_rest_routes/v1/load_more_categorized_stories/"+(Page+1)+"/"+Taxonomy+"/"+Slug, function( data ) {
      //alert(data);
